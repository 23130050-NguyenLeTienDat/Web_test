...
-- Procedure
 ...
 as 
 begin 
	select n.MaNGK, n.TenNGK, l.TenLoaiNGK
	from NGK n join LOAINGK l on n.MaLoaiNGK = l.MaLoaiNGK
end;
EXEC sp_ngk;
	--cau2
...
begin
	select n.*
	from NGK n join CT_DDH ct1 on ct1.MaNGK = n.MaNGK
	WHERE n.MaNGK NOT IN (SELECT DISTINCT MaNGK FROM CT_HOADON);
end;
exec sp_ton;
	--cau 4
create procedure sp_dt_qui 
	@QUY int, 
	@NAM int,
...
begin
	...
	where YEAR(hd.NgaylapHD) = @NAM and DATEPART(QUARTER, NgaylapHD) = @QUY
end;
DECLARE @Tong MONEY;
